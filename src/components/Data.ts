...
export const footerWhy: string[] = ['Scissors 101', 'Integration and API', 'Pricing'];
...
export const footerProducts: string[] = ['Link Management', 'QR Codes', 'Link-in-bio'];
export const footerCompany: string[] = [
  'About Scissor',
  'Careers',
  'Partners',
  'Press',
...
export const footerResources: string[] = [
  'Blog',
  'Resource',
  'Developers',
  'App Connectors',
...
export const footerFeatures: string[] = [
  'Branded Links',
  'Mobile Links',
  'Campaign',
...
export const questions: { id: string; question: string; answer: string }[] = [
  {
    id: nanoid(),
